    ...
    <main class="p-4 sm:ml-64 h-full">
        <div class="p-4 mt-14 rounded-lg dark:bg-gray-800">
            ...
            <div class="flex justify-between">
                <h6 class="text-lg font-bold dark:text-white">Usuarios</h6>
                            ...
                            <tr class=" dark:border-gray-700 border-b">
                                ...
                                <td class="px-6 py-4 ">
                                    <div class="flex gap-2">
                                        ...
                                        <form action="{{route('usuario.disable',$user->ci)}}" method="POST">
                                            @csrf
                                            @method('PUT')
                                            <button type="submit"
                                                class="font-medium {{$user->estado==2?'text-green-600':'text-red-600'}} hover:underline">{{$user->estado==2?'Habilitar':'Desabilitar'}}</button>
                                        </form>
