<x-login-layout>
    <main class=" bg-blue-50 h-full w-full justify-center items-center flex">

        <div class="min-w-96 bg-white p-4  rounded-xl">
                ...
                <form class="mx-auto p-4 rounded-lg" method="POST" action="{{route('login.auth')}}" class="mb-5">
                    ...
                    <button type="submit"
                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full 
                          sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Ingresar</button>
