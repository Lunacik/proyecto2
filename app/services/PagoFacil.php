...
class PagoFacil
{
    public function RecolectarDatos($request)
    {
        try {
    ...
    public function ConsultarEstado($request)
    {
    ...
    public function urlCallback($request)
    {
    ...
    public function generateQr($user,$idTransaction)
    { 
        try {
        $lcComerceID           = "d029fa3a95e174a19934857f535eb9427d967218a36ea014b70ad704bc6c8d1c";
        $lnMoneda              = 2;
        $lnTelefono            = $user['telefono'];
